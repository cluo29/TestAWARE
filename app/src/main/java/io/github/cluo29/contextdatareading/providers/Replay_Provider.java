...
public class Replay_Provider extends ContentProvider {
    ...
    public static final String[] TABLES_FIELDS = {
            Replay_Info._ID + " integer primary key autoincrement,"
                    ...
                    + Replay_Info.SENSOR + " text default '',"
                    + Replay_Info.DATASET + " text default '',"
                    + Replay_Info.STARTTIMESTAMP + " real default 0,"
                    + Replay_Info.SCHEDULE + " real default 0,"
    ...
    public boolean onCreate() {
        ...
        sensorMap.put(Replay_Info.SENSOR, Replay_Info.SENSOR);
        sensorMap.put(Replay_Info.DATASET, Replay_Info.DATASET);
        sensorMap.put(Replay_Info.STARTTIMESTAMP, Replay_Info.STARTTIMESTAMP);
        sensorMap.put(Replay_Info.SCHEDULE, Replay_Info.SCHEDULE);
