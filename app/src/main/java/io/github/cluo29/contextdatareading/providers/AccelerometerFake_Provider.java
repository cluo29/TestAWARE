...
public class AccelerometerFake_Provider extends ContentProvider {
     ...
     */
    public static String AUTHORITY = "io.github.cluo29.contextdatareading.provider.accelerometerfake";
    ...
    public static final class Accelerometer_Sensor implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://" + AccelerometerFake_Provider.AUTHORITY + "/sensor_accelerometer");

        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.contextdatareading.accelerometerfake.sensor";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.contextdatareading.accelerometerfake.sensor";
    ...
    public static final class Accelerometer_Data implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://"
                + AccelerometerFake_Provider.AUTHORITY + "/accelerometer");
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.contextdatareading.accelerometerfake.data";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.contextdatareading.accelerometerfake.data";
    ...
    public static String DATABASE_NAME = "accelerometerfake.db";
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = "io.github.cluo29.contextdatareading.provider.accelerometerfake";

        sUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sUriMatcher.addURI(AccelerometerFake_Provider.AUTHORITY,
                DATABASE_TABLES[0], ACCEL_DEV);
        sUriMatcher.addURI(AccelerometerFake_Provider.AUTHORITY, DATABASE_TABLES[0]
                + "/#", ACCEL_DEV_ID);
        sUriMatcher.addURI(AccelerometerFake_Provider.AUTHORITY,
                DATABASE_TABLES[1], ACCEL_DATA);
        sUriMatcher.addURI(AccelerometerFake_Provider.AUTHORITY, DATABASE_TABLES[1]
                + "/#", ACCEL_DATA_ID);
